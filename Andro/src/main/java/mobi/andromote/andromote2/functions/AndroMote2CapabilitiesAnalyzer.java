...
public class AndroMote2CapabilitiesAnalyzer implements CapabilitiesAnalyzer {
	private final Logger log = LoggerFactory.getLogger(AndroMote2CapabilitiesAnalyzer.class);
	...
	private void checkRideCapabilities() {
		if(VehicleController.INSTANCE.isRideAvailable()) {
