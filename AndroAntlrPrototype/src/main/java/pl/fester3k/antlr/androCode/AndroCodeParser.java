...
public class AndroCodeParser extends Parser {
	...
	public final BodyContext body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << K_INT_TYPE) | (1L << K_STRING_TYPE) | (1L << K_VOID_TYPE) | (1L << K_BOOLEAN_TYPE) | (1L << K_DEV_TYPE))) != 0)) {
				{
				{
	...
	public final FunctionContext function() throws RecognitionException {
		...
		try {
			...
			setState(81);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << K_INT_TYPE) | (1L << K_STRING_TYPE) | (1L << K_VOID_TYPE) | (1L << K_BOOLEAN_TYPE) | (1L << K_DEV_TYPE))) != 0)) {
				{
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 6) | (1L << 7) | (1L << 8) | (1L << 10) | (1L << 14) | (1L << 19) | (1L << K_INT_TYPE) | (1L << K_STRING_TYPE) | (1L << K_VOID_TYPE) | (1L << K_BOOLEAN_TYPE) | (1L << K_DEV_TYPE) | (1L << ID) | (1L << LP) | (1L << SUBST_OP) | (1L << INT) | (1L << STRING) | (1L << BOOLEAN) | (1L << NULL))) != 0)) {
				{
				{
	...
	public static class Stat_for_loopContext extends StatementContext {
		public For_loopContext for_loop() {
			return getRuleContext(For_loopContext.class,0);
		}
		public Stat_for_loopContext(StatementContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).enterStat_for_loop(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).exitStat_for_loop(this);
		}
	}
	public static class Stat_blockContext extends StatementContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).enterStat_block(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).exitStat_block(this);
		}
	}
	public static class Stat_exprContext extends StatementContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).enterStat_expr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).exitStat_expr(this);
		}
	}
	public static class Stat_if_conditionContext extends StatementContext {
		public If_conditionContext if_condition() {
			return getRuleContext(If_conditionContext.class,0);
		}
		public Stat_if_conditionContext(StatementContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).enterStat_if_condition(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).exitStat_if_condition(this);
		}
	}
	public static class Stat_while_loopContext extends StatementContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).enterStat_while_loop(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).exitStat_while_loop(this);
		}
	}
	public static class Stat_returnContext extends StatementContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).enterStat_return(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).exitStat_return(this);
		}
	}
	public static class Stat_var_declarationContext extends StatementContext {
		public Var_declarationContext var_declaration() {
			return getRuleContext(Var_declarationContext.class,0);
		}
		public Stat_var_declarationContext(StatementContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).enterStat_var_declaration(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).exitStat_var_declaration(this);
		}
	}
	public static class Stat_assignmentContext extends StatementContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).enterStat_assignment(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).exitStat_assignment(this);
		}
	}
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 3:
				_localctx = new Stat_var_declarationContext(_localctx);
			...
			case 5:
				_localctx = new Stat_for_loopContext(_localctx);
			...
			case 7:
				_localctx = new Stat_if_conditionContext(_localctx);
			...
			case 8:
				...
				setState(121);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 19) | (1L << ID) | (1L << LP) | (1L << SUBST_OP) | (1L << INT) | (1L << STRING) | (1L << BOOLEAN) | (1L << NULL))) != 0)) {
					{
					setState(120); expr(0);
					}
				}
	...
	public static class ExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AndroCodeListener ) ((AndroCodeListener)listener).exitExpr(this);
		}
	}
	...
	public final ValueContext value() throws RecognitionException {
		...
		try {
			...
			setState(239);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << INT) | (1L << STRING) | (1L << BOOLEAN) | (1L << NULL))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public static final String _serializedATN =
		...
		"#$\3\2!\"\3\2&+\3\2,/\3\2\30\34\u00ff\2/\3\2\2\2\4\65\3\2\2\2\69\3\2\2"+
		"\2\bI\3\2\2\2\nO\3\2\2\2\fX\3\2\2\2\16`\3\2\2\2\20c\3\2\2\2\22~\3\2\2"+
		"\2\24\u0091\3\2\2\2\26\u00a1\3\2\2\2\30\u00a7\3\2\2\2\32\u00ab\3\2\2\2"+
		"\34\u00b2\3\2\2\2\36\u00b6\3\2\2\2 \u00be\3\2\2\2\"\u00c8\3\2\2\2$\u00ce"+
		"\3\2\2\2&\u00e2\3\2\2\2(\u00f1\3\2\2\2*\u00f3\3\2\2\2,.\5\4\3\2-,\3\2"+
		"\2\2.\61\3\2\2\2/-\3\2\2\2/\60\3\2\2\2\60