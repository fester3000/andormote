...
public enum VehicleComponentsFactory {
	...
	public ElectronicDevice getMotorDriver(MotorDriverType type, RobotHardware parentDevice) throws UnknownDeviceException {
	...
	public ElectronicDeviceInterface getModel(DeviceDefinitions.MobilePlatformType type, ElectronicDevice driver, RobotHardware parentDevice) throws UnknownDeviceException {
