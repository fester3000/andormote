...
public class PlatformNewBright extends ElectronicDeviceInterfaceAbstract {
	...
	public PlatformNewBright(MotorDriverNewBrightCompatible driver, RobotHardware device) {
		super(device);
		this.driver = driver;
	}
